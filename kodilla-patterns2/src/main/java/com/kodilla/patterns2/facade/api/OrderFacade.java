...
public class OrderFacade {
    ...
    public void processOrder (OrderDto order, Long userId) throws OrderProcessingException{
        ...
        try {
            ...
            LOGGER.info("Order values is:" + value + " USD");
            ...
            if (!shopService.verifyOrder(orderId)) {
                LOGGER.error(OrderProcessingException.ERR_VERIFICATION__ERROR);
                wasError = true;
                throw new OrderProcessingException(OrderProcessingException.ERR_VERIFICATION__ERROR);
            }
